...
<head>
    ...
    <style type="text/css">
        ...
        .toolbar .delete {
            background-image: url(/assets/admin/layout/img/icons_edit.png);
...
<div class="row">
    <div class="col-md-12 delete-padding-rt">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="${rc.contextPath}/goods/catagory">审核管理</a>
            </li>
        </ul>
    </div>
</div>
        ...
        <div class="portlet box green-haze">
            ...
            <div class="portlet-body form" style="background-color:#ffffff;">
                <form class="form-horizontal form-bordered" enctype="multipart/form-data"  method="POST" id="goodsForm"  action="${rc.contextPath}/goods/stuff/${action}">
                    <input type="hidden" name="id" id="goodsId" value="${goods.goodsId}"/>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group" style="height: 140px">
                            <label class="col-md-2 control-label" style="line-height:140px;height: 120px">图片</label>
                                ...
                                <div style="height:100px">
                                   ...
                                   <#-- <span class="btn green btn-file" id="uploadFile_clone1"
                                    ...
                                    <span id="localImag"
                                        ...
                                        <img src="${goods.imageUrl}?id=javascript:Math.random()"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="name" placeholder="请输入商品名称" readonly="readonly" disabled="disabled"
                                       value="${goods.name}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="sn" placeholder="请输入商品编号" readonly="readonly" disabled="disabled"
                                       value="${goods.sn}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="stock" placeholder="请输入商品库存" readonly="readonly" disabled="disabled"
                                       value="${goods.stock}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="referencePrice" placeholder="请输入参考价" readonly="readonly" disabled="disabled"
                                       value="${goods.referencePrice}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">兑换积分<span class="required">*</span></label>
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="point" placeholder="请输入商品兑换积分" readonly="readonly" disabled="disabled"
                                       value="${goods.point}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <#list cataList as cata>
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="cataIds" value="${cata.id}" readonly="readonly" disabled="disabled" />${cata.name}
                                </label>
                            </#list>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <#list typeList as type>
                                <label class="radio-inline" style="position: relative;width: 90px;">
                                    <input type="radio" name="goodsType" value="${type.id}"  readonly="readonly" disabled="disabled"  />
                    ...
                    <div class="form-actions fluid">
                     ...
                     <#--   <@shiro.hasPermission name="goods-review-Save">
                            <button type="submit" class="btn green">保存</button>
                        </@shiro.hasPermission>-->
                        <button type="button" class="btn default"
                                onclick="javascript:window.location.href='${rc.contextPath}/goods/review';">返回
                        </button>
                        </div>
                    </div>
                </form>
                ...
                , done: function (res) {
                    ...
                    if (res.stat) {
                        ...
                        $('#carouselDiv').append('<div class="picture-item" id="itemImg' + res.imgName + '"  >' +
                                '<input type="hidden" id="carouselImage" name="carouselImage"  value="'+res.imagePath+'" /><div height="120px"><img src="' + res.imagePath + '?id='+Math.random()+'"  class="layui-upload-img"  style="margin-left: 15px;" width="150px" height="150px"/></div>' +
                                '<div class="img_cover"></div>' +
                                '<div class="toolbar_wrap">' +
                                '<div class="opacity"></div>' +
