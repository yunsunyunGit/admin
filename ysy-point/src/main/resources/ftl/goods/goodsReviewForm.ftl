                ...
                <form class="form-horizontal form-bordered" enctype="multipart/form-data"  method="POST" id="goodsForm"  action="${rc.contextPath}/goods/stuff/${action}">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="sn" placeholder="请输入商品编号"
                                       value="${goods.sn}"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="referencePrice" placeholder="请输入参考价"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="point" placeholder="请输入商品兑换积分"
                                       value="${goods.point}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <#list cataList as cata>
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="cataIds" value="${cata.id}">${cata.name}
                                </label>
                            </#list>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <#list typeList as type>
                                <label class="radio-inline" style="position: relative;width: 90px;">
                                    <input type="radio" name="goodsType" value="${type.id}">
                    ...
                    <div class="form-actions fluid">
                        ...
                        <button type="button" class="btn default"
                                onclick="javascript:window.location.href='${rc.contextPath}/goods/review';">取消
                        </button>
                        </div>
                    </div>
                </form>
