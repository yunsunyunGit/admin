    ...
    $.extend($.validator, {
                    ...
                    if ( !this.labelContainer.append(label).length ) {
                        if ( this.settings.errorPlacement ) {
                            ...
                            if ($(element).parent(".input-group").size() > 0) {
                                label.insertAfter($(element).parent(".input-group"));
                            } else {
                                label.insertAfter(element); // for other inputs, just perform default behavior
                            }
                        }
                    }
                }
        ...
        methods: {
            ...
            telephone: function( value, element ) {
                return this.optional(element) || /^((0\d{2,3})-)(\d{7,8})(-(\d{3,}))?$/i.test(value);
            },

            phone: function( value, element ) {
                return this.optional(element) ||  /^0?(13[0-9]|15[0-9]|18[0-9]|17[0-9]|14[57])[0-9]{8}$/i.test(value);
            },
