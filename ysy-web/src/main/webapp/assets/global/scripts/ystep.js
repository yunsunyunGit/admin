  ...
  $.fn.extend({
    ...
    loadStep: function(params){
      ...
      var baseHtml =  "<div class='ystep-container'>"+
          ...
          "</div>";
      //步骤框架
      var stepHtml = "<li class='ystep-step ystep-step-undone' onClick='stageClick(this)' data-container='body' data-toggle='popover' data-placement='top' data-title='' data-content='' data-trigger='hover'>"+
          "</li>";
      //决策器
      var logic = {
        size: {
